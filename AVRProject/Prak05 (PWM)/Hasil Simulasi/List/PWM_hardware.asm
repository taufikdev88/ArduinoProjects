...
_0x0:
	.DB  0x44,0x75,0x74,0x79,0x3A,0x20,0x0,0x20
	.DB  0x70,0x65,0x72,0x73,0x65,0x6E,0x0,0x4C
	.DB  0x6F,0x76,0x65,0x20,0x55,0x20,0x42,0x65
	.DB  0x69,0x62,0x0
...
; 0000 0033 // State7=P State6=P State5=P State4=P State3=P State2=P State1=P State0=P
; 0000 0034 PORTC=0xFF;
	OUT  0x15,R30
; 0000 0035 DDRC=0x00;
	LDI  R30,LOW(0)
	OUT  0x14,R30
...
; 0000 0048 // Clock value: 1382.400 kHz
; 0000 0049 // Mode: Fast PWM top=ICR1
; 0000 004A // OC1A output: Non-Inv.
; 0000 004B // OC1B output: Non-Inv.
...
; 0000 0052 TCCR1A=0xA2;
	LDI  R30,LOW(162)
	OUT  0x2F,R30
; 0000 0053 TCCR1B=0x1A;
	LDI  R30,LOW(26)
	OUT  0x2E,R30
...
; 0000 008E       duty_in = 100.0*PINC/255;
	IN   R30,0x13
	LDI  R31,0
	RCALL __CWD1
	RCALL __CDF1
	...
	RCALL __DIVF21
	RCALL __PUTD1S0
; 0000 008F       OCR1A = (int) 13824 * (duty_in / 100);
	RCALL __GETD2S0
	__GETD1N 0x42C80000
	RCALL __DIVF21
	__GETD2N 0x46580000
...
; 0000 0090       LCD_GotoXY(0,0);
	...
	LDI  R26,LOW(0)
	RCALL _LCD_GotoXY
; 0000 0091       LCD_Text("Duty: ");
	__POINTW2MN _0x39,0
	RCALL _LCD_Text
; 0000 0092       LCD_Angka3(duty_in);
	RCALL __GETD1S0
	RCALL __CFD1
	MOVW R26,R30
	RCALL _LCD_Angka3
; 0000 0093       LCD_Text(" persen");
	__POINTW2MN _0x39,7
	RCALL _LCD_Text
; 0000 0094       LCD_GotoXY(0,1);
	...
	LDI  R26,LOW(1)
	RCALL _LCD_GotoXY
; 0000 0095       LCD_Text("Love U Beib");
	__POINTW2MN _0x39,15
	RCALL _LCD_Text
; 0000 0096       }
	RJMP _0x36
; 0000 0097 }
