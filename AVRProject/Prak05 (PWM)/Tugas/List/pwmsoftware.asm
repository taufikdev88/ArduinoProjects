...
; 0000 0020 static int counter = 0;
; 0000 0021 if (++counter>999)
...
; 0000 0024     PORTD.4 = 1;
	SBI  0x12,4
; 0000 0025 }
; 0000 0026 if (pwm==counter) PORTD.4 = 0;
_0x3:
...
; 0000 003E // State7=P State6=P State5=P State4=P State3=P State2=P State1=P State0=P
...
; 0000 004A // Clock value: 11059.200 kHz
; 0000 004B // Mode: CTC top=OCR0
; 0000 004C // OC0 output: Disconnected
; 0000 004D TCCR0=0x09;
	LDI  R30,LOW(9)
	OUT  0x33,R30
