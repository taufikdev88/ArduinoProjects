...
; 0000 0036 // State7=P State6=P State5=P State4=P State3=P State2=P State1=P State0=P
...
; 0000 003B // Func7=In Func6=In Func5=Out Func4=In Func3=In Func2=In Func1=In Func0=In
; 0000 003C // State7=T State6=T State5=0 State4=T State3=T State2=T State1=T State0=T
...
; 0000 004C // Mode: CTC top=OCR1A
; 0000 004D // OC1A output: Toggle
...
; 0000 0055 TCCR1A=0x40;
	LDI  R30,LOW(64)
	OUT  0x2F,R30
; 0000 0056 TCCR1B=0x09;
	LDI  R30,LOW(9)
	OUT  0x2E,R30
...
; 0000 005A ICR1L=0x00;
	OUT  0x26,R30
; 0000 005B OCR1AH=0x15;
	LDI  R30,LOW(21)
	OUT  0x2B,R30
; 0000 005C OCR1AL=0x98;
	LDI  R30,LOW(152)
	OUT  0x2A,R30
