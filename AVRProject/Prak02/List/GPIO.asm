...
; 0000 0020     unsigned char a;
; 0000 0021     int lastPos = 1;
; 0000 0022 
...
; 0000 0032 // State7=P State6=P State5=P State4=P State3=P State2=P State1=P State0=P
...
; 0000 0084 TWCR=0x00;
	OUT  0x36,R30
; 0000 0085 
; 0000 0086 a = 0b00000011;
	LDI  R17,LOW(3)
; 0000 0087 while (1)
_0x3:
; 0000 0088     {
; 0000 0089     // PINC.1 untuk mengubah jumlah lampu yang menyala
; 0000 008A     if(PINC.1==1 && lastPos==0)
	SBIS 0x13,1
	RJMP _0x7
	CLR  R0
	CP   R0,R18
...
; 0000 008C         lastPos = 1;
	__GETWRN 18,19,1
; 0000 008D         a = a & (a>>1 | a<<7);
	RCALL SUBOPT_0x0
	AND  R17,R30
; 0000 008E         continue;
	RJMP _0x3
; 0000 008F     }
; 0000 0090     else if(PINC.1==0 && lastPos==1)
_0x6:
	LDI  R26,0
	SBIC 0x13,1
	LDI  R26,1
...
; 0000 0095     }
; 0000 0096 
; 0000 0097     // PINC.0 untuk mengubah arah
; 0000 0098     a = PINC.0 ? a<<1 | a>>7 : a>>1 | a<<7;
_0xA:
	SBIS 0x13,0
	RJMP _0xD
	RCALL SUBOPT_0x1
...
_0x11:
	...
	OR   R31,R23
	MOV  R17,R30
; 0000 0099     PORTB=~a;         // ini untuk mengeluarkan a ke port b
	MOV  R30,R17
	COM  R30
	OUT  0x18,R30
; 0000 009A 
; 0000 009B     // PINC.2 untuk mengubah lamanya delay
; 0000 009C     //delay_ms(PINC.2 ? 200 : 100);   // ini untuk menjeda untuk loop selanjutnya
