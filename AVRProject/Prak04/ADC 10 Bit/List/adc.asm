...
; 0000 0041 // State7=P State6=P State5=P State4=P State3=P State2=P State1=P State0=P
; 0000 0042 PORTC=0xFF;
	OUT  0x15,R30
; 0000 0043 DDRC=0x00;
	LDI  R30,LOW(0)
	OUT  0x14,R30
...
; 0000 008A // ADC Clock frequency: 86.400 kHz
; 0000 008B // ADC Voltage Reference: AREF pin
; 0000 008C // ADC High Speed Mode: Off
; 0000 008D // ADC Auto Trigger Source: ADC Stopped
; 0000 008E ADMUX=ADC_VREF_TYPE & 0xff;
	OUT  0x7,R30
; 0000 008F ADCSRA=0x87;
	LDI  R30,LOW(135)
	OUT  0x6,R30
; 0000 0090 SFIOR&=0xEF;
	IN   R30,0x30
	ANDI R30,0xEF
	OUT  0x30,R30
; 0000 0091 
...
; 0000 00A0           LCD_GotoXY(0,0); LCD_Angka4(read_adc(0));
	LDI  R30,LOW(0)
	ST   -Y,R30
	LDI  R26,LOW(0)
	RCALL _LCD_GotoXY
	LDI  R26,LOW(0)
	RCALL SUBOPT_0x7
; 0000 00A1           LCD_GotoXY(7,0); LCD_Angka4(read_adc(1));
	LDI  R30,LOW(7)
	ST   -Y,R30
	LDI  R26,LOW(0)
	RCALL _LCD_GotoXY
	LDI  R26,LOW(1)
	RCALL SUBOPT_0x7
; 0000 00A2           LCD_GotoXY(0,1); LCD_Angka4(read_adc(2));
	LDI  R30,LOW(0)
	ST   -Y,R30
	LDI  R26,LOW(1)
	RCALL _LCD_GotoXY
	LDI  R26,LOW(2)
	RCALL SUBOPT_0x7
; 0000 00A3           LCD_GotoXY(7,1); LCD_Angka4(read_adc(3));
	LDI  R30,LOW(7)
	ST   -Y,R30
	LDI  R26,LOW(1)
	RCALL _LCD_GotoXY
