...
{   putchar (x/100+48);     // kirim karakter data ratusan
    putchar ((x/10)%10+48); // kirim karakter data puluhan
    putchar (x%10+48);      // kirim karakter data satuan    
}
...
unsigned char hasil;    // variabel penampung untuk konversi string ke decimal
