...
_0x0:
	.DB  0x42,0x69,0x6E,0x65,0x72,0x20,0x3A,0x0
	.DB  0x54,0x61,0x6D,0x62,0x61,0x68,0x3A,0x0
...
; 0000 0022 char x = 0;
; 0000 0023 char buff[16];
; 0000 0024 unsigned int i = 0;
; 0000 0025 unsigned int a = 0;
; 0000 0026 unsigned int jumlah = 0;
; 0000 0027 
...
; 0000 0037 // State7=P State6=P State5=P State4=P State3=P State2=P State1=P State0=P
...
; 0000 008B LCD_Init();
	RCALL _LCD_Init
; 0000 008C 
; 0000 008D LCD_TulisF(0,"Biner :");
	LDI  R30,LOW(0)
	ST   -Y,R30
	__POINTW2FN _0x0,0
	RCALL _LCD_TulisF
; 0000 008E LCD_TulisF(1,"Tambah:");
	LDI  R30,LOW(1)
	ST   -Y,R30
	__POINTW2FN _0x0,8
	RCALL _LCD_TulisF
...
; 0000 0093       // membaca dan mengeluarkan angka biner yang dibaca dari Port C
; 0000 0094       x = PINC;
	IN   R17,19
; 0000 0095       LCD_GotoXY(0,0);
	...
	LDI  R26,LOW(0)
	RCALL _LCD_GotoXY
; 0000 0096       for(i=0; i<=7; i++)
	__GETWRN 18,19,0
_0x39:
	__CPWRN 18,19,8
	BRSH _0x3A
; 0000 0097       {
; 0000 0098             if((x & (1<<(7-i)))==0)
	LDI  R30,LOW(7)
	LDI  R31,HIGH(7)
	SUB  R30,R18
	SBC  R31,R19
	...
	SBIW R30,0
	BRNE _0x3B
; 0000 0099                 LCD_Text("0");
	__POINTW2MN _0x3C,0
	RJMP _0x40
; 0000 009A             else
_0x3B:
; 0000 009B                 LCD_Text("1");
	__POINTW2MN _0x3C,2
_0x40:
	RCALL _LCD_Text
; 0000 009C       }
