...
; 0000 0085 TWCR=0x00;
	OUT  0x36,R30
; 0000 0086 
; 0000 0087 // I2C Bus initialization
; 0000 0088 // I2C Port: PORTC
; 0000 0089 // I2C SDA bit: 1
; 0000 008A // I2C SCL bit: 0
; 0000 008B // Bit Rate: 100 kHz
; 0000 008C // Note: I2C settings are specified in the
; 0000 008D // Project|Configure|C Compiler|Libraries|I2C menu.
; 0000 008E i2c_init();
	RCALL _i2c_init
; 0000 008F 
; 0000 0090 while (1)
...
; 0000 0094 i2c_start();
	RCALL _i2c_start
; 0000 0095 i2c_write(0xA0);
	LDI  R26,LOW(160)
	RCALL SUBOPT_0x0
; 0000 0096 i2c_stop();
; 0000 0097 i2c_start();
; 0000 0098 i2c_write(0xA5);
	LDI  R26,LOW(165)
	RCALL SUBOPT_0x0
; 0000 0099 i2c_stop();
; 0000 009A i2c_start();
; 0000 009B i2c_write(0xAA);
	LDI  R26,LOW(170)
	RCALL SUBOPT_0x0
; 0000 009C i2c_stop();
; 0000 009D i2c_start();
; 0000 009E i2c_write(0xE0);
	LDI  R26,LOW(224)
	RCALL _i2c_write
; 0000 009F i2c_stop();
	RCALL _i2c_stop
