...
; 0000 0047 // Clock value: 1382.400 kHz
; 0000 0048 // Mode: Fast PWM top=ICR1
...
; 0000 0051 TCCR1A=0xA2;
	LDI  R30,LOW(162)
	OUT  0x2F,R30
; 0000 0052 TCCR1B=0x1A;
	LDI  R30,LOW(26)
	OUT  0x2E,R30
...
; 0000 0054 TCNT1L=0x00;
	OUT  0x2C,R30
; 0000 0055 ICR1H=0x36;
	LDI  R30,LOW(54)
	OUT  0x27,R30
; 0000 0056 ICR1L=0x00;
	LDI  R30,LOW(0)
	OUT  0x26,R30
; 0000 0057 OCR1AH=0x28;
	LDI  R30,LOW(40)
	OUT  0x2B,R30
; 0000 0058 OCR1AL=0x80;
	LDI  R30,LOW(128)
	OUT  0x2A,R30
; 0000 0059 OCR1BH=0x28;
	LDI  R30,LOW(40)
	OUT  0x29,R30
; 0000 005A OCR1BL=0x80;
	LDI  R30,LOW(128)
	OUT  0x28,R30
; 0000 005B 
...
; 0000 0089            data = ~PINC;
	...
	COM  R30
	MOV  R17,R30
; 0000 008A            PORTB = data;
	OUT  0x18,R17
; 0000 008B            OCR1A = (PINC/255.0) * 13824.0;
	RCALL SUBOPT_0x0
	OUT  0x2A+1,R31
	OUT  0x2A,R30
; 0000 008C            OCR1B = (PINC/255.0) * 13824.0;
	RCALL SUBOPT_0x0
	OUT  0x28+1,R31
	OUT  0x28,R30
