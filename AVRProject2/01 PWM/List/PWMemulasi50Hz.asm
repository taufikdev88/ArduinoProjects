...
; 0000 002A     static int counter=0;
; 0000 002B     if(++counter>799)	// jika hitungan counter sudah sampai di TOP (800)
	LDI  R26,LOW(_counter_S0000000000)
	LDI  R27,HIGH(_counter_S0000000000)
	LD   R30,X+
	LD   R31,X+
	ADIW R30,1
	ST   -X,R31
	...
	CPC  R31,R26
	BRLT _0x3
; 0000 002C     {  counter=0;		// reset nilai counter
	LDI  R30,LOW(0)
	STS  _counter_S0000000000,R30
	STS  _counter_S0000000000+1,R30
; 0000 002D        PORTB=0xFF;
	LDI  R30,LOW(255)
	OUT  0x18,R30
; 0000 002E // semua nilai bit dari PORTB dibuat 1 (start sinyal PWM)
; 0000 002F // perintah langsung mengakses ke port karena lebih efisien dibanding
; 0000 0030 // membuat masing-masing bit menjadi 1
; 0000 0031     }
; 0000 0032     if(pwm1==counter) PWM_1_OUT = 0;
_0x3:
	RCALL SUBOPT_0x0
	CP   R30,R4
	CPC  R31,R5
	BRNE _0x4
	CBI  0x18,0
; 0000 0033     if(pwm2==counter) PWM_2_OUT = 0;
_0x4:
	RCALL SUBOPT_0x0
	CP   R30,R6
	CPC  R31,R7
	BRNE _0x7
	CBI  0x18,1
; 0000 0034     if(pwm3==counter) PWM_3_OUT = 0;
_0x7:
	RCALL SUBOPT_0x0
	CP   R30,R8
	CPC  R31,R9
	BRNE _0xA
	CBI  0x18,2
; 0000 0035     if(pwm4==counter) PWM_4_OUT = 0;
_0xA:
	RCALL SUBOPT_0x0
	CP   R30,R10
	CPC  R31,R11
	BRNE _0xD
	CBI  0x18,3
; 0000 0036     if(pwm5==counter) PWM_5_OUT = 0;
_0xD:
	RCALL SUBOPT_0x0
	CP   R30,R12
	CPC  R31,R13
	BRNE _0x10
	CBI  0x18,4
; 0000 0037     if(pwm6==counter) PWM_6_OUT = 0;
_0x10:
	RCALL SUBOPT_0x0
	LDS  R26,_pwm6
	LDS  R27,_pwm6+1
	...
	BRNE _0x13
	CBI  0x18,5
; 0000 0038     if(pwm7==counter) PWM_7_OUT = 0;
_0x13:
	RCALL SUBOPT_0x0
	LDS  R26,_pwm7
	LDS  R27,_pwm7+1
	...
	BRNE _0x16
	CBI  0x18,6
; 0000 0039     if(pwm8==counter) PWM_8_OUT = 0;
_0x16:
	RCALL SUBOPT_0x0
	LDS  R26,_pwm8
	LDS  R27,_pwm8+1
...
; 0000 00A6 #asm("sei")
	sei
; 0000 00A7 
; 0000 00A8 // mengatur nilai duty cycle dari sinyal PWM (nilai 800 = maksimal, DC 100%)
; 0000 00A9 pwm1 = 80;	//10/100*800 = (10%)
	LDI  R30,LOW(80)
	LDI  R31,HIGH(80)
	MOVW R4,R30
; 0000 00AA pwm2 = 160;	//10/100*800 = (20%)
	LDI  R30,LOW(160)
	LDI  R31,HIGH(160)
	MOVW R6,R30
; 0000 00AB pwm3 = 240;	//10/100*800 = (30%)
	LDI  R30,LOW(240)
	LDI  R31,HIGH(240)
	MOVW R8,R30
; 0000 00AC pwm4 = 320;	//10/100*800 = (40%)
	LDI  R30,LOW(320)
	LDI  R31,HIGH(320)
	MOVW R10,R30
; 0000 00AD pwm5 = 400;	//10/100*800 = (50%)
	LDI  R30,LOW(400)
	LDI  R31,HIGH(400)
	MOVW R12,R30
; 0000 00AE pwm6 = 480;	//10/100*800 = (60%)
	LDI  R30,LOW(480)
	LDI  R31,HIGH(480)
	STS  _pwm6,R30
	STS  _pwm6+1,R31
; 0000 00AF pwm7 = 560;	//10/100*800 = (70%)
	LDI  R30,LOW(560)
	LDI  R31,HIGH(560)
	STS  _pwm7,R30
	STS  _pwm7+1,R31
; 0000 00B0 pwm8 = 640;	//10/100*800 = (80%)
	LDI  R30,LOW(640)
	LDI  R31,HIGH(640)
	STS  _pwm8,R30
	STS  _pwm8+1,R31
...
_pwm8:
	.BYTE 0x2
_counter_S0000000000:
	.BYTE 0x2

	.CSEG
;OPTIMIZER ADDED SUBROUTINE, CALLED 8 TIMES, CODE SIZE REDUCTION:19 WORDS
SUBOPT_0x0:
	LDS  R30,_counter_S0000000000
	LDS  R31,_counter_S0000000000+1
	RET
