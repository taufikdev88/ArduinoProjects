...
; 0000 008B // ADC Clock frequency: 86.400 kHz
; 0000 008C // ADC Voltage Reference: AREF pin
; 0000 008D // ADC High Speed Mode: Off
; 0000 008E // ADC Auto Trigger Source: ADC Stopped
...
; 0000 0091 ADMUX=ADC_VREF_TYPE & 0xff;
	LDI  R30,LOW(32)
	OUT  0x7,R30
; 0000 0092 ADCSRA=0x87;
	LDI  R30,LOW(135)
	OUT  0x6,R30
; 0000 0093 SFIOR&=0xEF;
	IN   R30,0x30
	ANDI R30,0xEF
	OUT  0x30,R30
; 0000 0094 
...
; 0000 00A0          PORTB = read_adc(0);   //menampilkan data ADC pada PORTB (LCD)
	LDI  R26,LOW(0)
	RCALL _read_adc
	OUT  0x18,R30
