...
#define PwmMKi(o)       OCR3BH = ((unsigned char)(o>>8)); OCR3BL = (unsigned char)o;  #define SetDirMKi       (PORTE.5 = 1)
#define ClrDirMKi       (PORTE.5 = 0)
#define DirMKi(o)       (o ? SetDirMKi:ClrDirMKi)
// Definisi Port Motor kanan
#define PwmMKa(o)       OCR3AH = ((unsigned char)(o>>8)); OCR3AL = (unsigned char)o;  #define SetDirMKa       (PORTE.2 = 1)
