...
LCD_TulisF(0,"Enk.Kanan:");
LCD_TulisF(1,"Enk.Kiri :");

while (1)
      {
      // Place your code here
      // menampilkan data Enkoder motor Kanan
      LCD_GotoXY(10,0); LCD_Angka4(EnkoderKa); LCD_Data(' ');
      // menampilkan data Enkoder motor Kiri
      LCD_GotoXY(10,1); LCD_Angka4(EnkoderKi); LCD_Data(' ');
      }
