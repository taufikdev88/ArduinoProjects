...
//************************************** fungsi tambahan i2c ***************************************************
// devAddr = alamat device
// regAddr = alamat register yang diakses
// * data = bisa berupa data dalam bentuk array atau pointer

// membaca data 1 byte dari I2C
unsigned char I2C_ReadByte(uint8_t devAddr, uint8_t regAddr) 
{   //request register
    uint8_t Data;
...
// membaca data beberapa byte dari I2C (sebanyak length)
...
// menuliskan beberapa byte data ke I2C (sebanyak length)
