...
void myBuzzer::Nada1(void)
{
    ...
    Lagu(OFF);
    #endif // UseMusic
    Beep(1000,200);     Beep(500,20);
    Beep(3000,100);     Beep(500,20);
    Beep(3000,200);     Beep(500,20);
    Beep(2000,100);
}
...
void myBuzzer::Nada2(void)
{
    ...
    #endif // UseMusic
    Beep(3000,200);     Beep(500,20);
    Beep(2500,250);     Beep(500,20);
    Beep(1000,100);     Beep(500,20);
    Beep(3000,100);
}
...
void myBuzzer::Nada4(void)
{
    ...
    Lagu(OFF);
    #endif // UseMusic
    Beep(2000,250);     Beep(500,20);
    Beep(3000,100);     Beep(500,20);
    Beep(3500,100);     Beep(500,20);
    Beep(3000,200);
}
